         	...
         	<div class="tab-content">
           		 <div class="tab-panel active" id="home">
                      ...
                      <div class="form-group">
                           <div class="col-sm-12">
                                <br>
                              	<button class="btn btn-md btn-success col-md-4 col-sm-12" type="submit"><i class="glyphicon glyphicon-ok-sign"></i> Save</button>
                               	<button class="btn btn-md btn-danger col-md-2 col-sm-6 my-2" type="reset"><i class="glyphicon glyphicon-repeat"></i> Reset</button>
                            </div>
                      </div>
              	</form>
			<hr>
